  ...
  describe("Default user", () => {
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "dd66283f46626ddcd0f6268978b5d3683bb2f0b88c47793975cb1684f21379e26168f4063f1d719566d211587b2a9b13";
    ...
    test("With expired session", async () => {
      jest.useFakeTimers({
        now: new Date(Date.now() - session.EXPIRATION_IN_MILLISECONDS - 100000),
      });
    ...
    test("With almost expired session", async () => {
      ...
      const createdUser = await orchestrator.createUser({
        username: "UserWithAlmostInvalidSession",
      });
